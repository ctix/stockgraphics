...
interaction by drawing a crosshair that follows
the mouse.
...
win.addItem(label)
for i in range(1,4):
    c1 = win.addLabel("col ",0,i)
    # c1 = win.addLabel("column 2 ",0,1)
    # c1 = win.addLabel("column 3 ",0,2)
    # c1 = win.addLabel("column4 ",0,3)
    r1 = win.addLabel("r1 ",i,0)
    # r1 = win.addLabel("row2 ",2,0)
    # r1 = win.addLabel("row3 ",3,0)
